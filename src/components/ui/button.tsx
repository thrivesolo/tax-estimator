    ...
    return (
      <button
        className={cn(
          ...
          {
            "bg-primary text-white hover:bg-primary/90 focus:ring-primary shadow-sm hover:shadow": variant === "default",
            "bg-secondary text-white hover:bg-secondary/90 focus:ring-secondary shadow-sm hover:shadow": variant === "secondary",
